...
SELECT MV.MVCODE AS MVCODE, MV.MVTITLE AS MVTITLE, MV.MVPOSTER AS MVPOSTER, 
		TH.THNAME AS THNAME,
		RE.RECODE AS RECODE, RE.SCHALL AS SCHALL, RE.SCDATE AS SCDATE, RE.REDATE AS REDATE
		FROM RESERVES RE
		...
		VALUES('RE00004','LCY','MV00024', 'TH00005', '5관', TO_DATE('2024/12/01' ,'YYYY/MM/DD HH24:MI'), SYSDATE);
