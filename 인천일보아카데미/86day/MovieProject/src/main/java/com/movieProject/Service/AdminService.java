	...
	public int addCgvTheaters() {
		...
		for (String url : theaterUrls) {
			...
			try {
				...
				WebElement thtelElement = driver.findElement(By.cssSelector("#contents > div.wrap-theater > div.sect-theater > div > div.box-contents > div.theater-info > span.txt-info > em:nth-child(1)"));
				String thtel = thtelElement.getText();
				th.setThtel(thtel);
				System.out.println("전화번호 : " + thtel);
				
				WebElement thinfoElement = driver.findElement(By.cssSelector("#contents > div.wrap-theater > div.sect-theater > div > div.box-contents > div.theater-info > span.txt-info > em:nth-child(2)"));
				...
				th.setThimg(thimg);
				System.out.println("이미지 : " + thimg); System.out.println();
