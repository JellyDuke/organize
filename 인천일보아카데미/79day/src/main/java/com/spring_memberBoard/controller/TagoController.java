...
public class TagoController {
	...
	public @ResponseBody String getTagoSttnList(String lati, String longti) throws IOException {
		...
		System.out.println("정류소 목록 조회 요청 - getTagoSttnList()");
	...
	public @ResponseBody String getTagoBusNodeList(String citycode, String routeid) throws IOException {
		...
		System.out.println("노선별 경유 정류소 목록 조회 요청 - /getTagoBusNodeList");
		
		String result = tagosvc.getBusNodeList(citycode, routeid);
	...
	public @ResponseBody String getTagoBusLocList(String citycode, String routeid) throws IOException {
		...
		System.out.println("노선별 버스 위치 목록 조회 - /getTagoBusLocList");
		
		String result = tagosvc.getBusLocList(citycode, routeid);
