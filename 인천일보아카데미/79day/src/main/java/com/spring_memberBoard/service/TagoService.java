...
public class TagoService {
	...
	private final String appKey = "8OvoimSoCKXfv2Wa7NepTHLutBaBTOwL%2FcxzPQu0DlfMwuSpUJWyeqXpvmUC3QQ7i0AA%2FGvzvAMGk5TgO1oIzg%3D%3D";
...
//      return result;  
	...
	public String getBusNodeList(String citycode, String routeid) throws IOException {
        ...
        JsonArray busNodeList = busNodeJson.get("response").getAsJsonObject().get("body").getAsJsonObject().get("items").getAsJsonObject().get("item").getAsJsonArray();
	...
	public String getBusLocList(String citycode, String routeid) throws IOException {
        ...
        JsonArray busLocList = busLocJson.get("response").getAsJsonObject().get("body").getAsJsonObject().get("items").getAsJsonObject().get("item").getAsJsonArray();
