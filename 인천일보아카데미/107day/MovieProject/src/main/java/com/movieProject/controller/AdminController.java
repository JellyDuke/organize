...
public class AdminController {
	...
	public ModelAndView getCgvScheduleInfo() {
		System.out.println("CGV 극장 정보 수집 요청 - /getCgvScheduleInfo");
		
		int addCount = adsvc.addCgvSchedules();
		System.out.println("추가 :" + addCount);
	...
	@RequestMapping(value = "/failReserveInfo")
	public @ResponseBody String failReserve(Reserve reInfo, HttpSession session) {
		System.out.println("Controller - failReserve");
		
		String loginId = (String)session.getAttribute("loginId");
		String recode = reInfo.getRecode();
		
		System.out.println(recode);
		int result = adsvc.failReserve(recode,loginId);
		return result+"";
	}
}
