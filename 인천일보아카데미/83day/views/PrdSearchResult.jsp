...
<body>
	...
	<div class ="prdArea">
		<table class="prd_11st">
			<thead>
				<tr>
					<th>쇼핑몰</th>
					<th>상품이름</th>
					<th>상품가격
						<select onchange="prdSort2(this.value)">
							<option value="price_desc">↑</option>
							<option value="price_asc">↓</option>
						</select>
					</th>
	...
	<script>
		function prdSort2(sortOption/*,objId*/) {
			console.log(sortOption);
			// let idPrdList = document.querySelector("#"+objId);
			// let prdList = sortOption.parentElement.parentElement.parentElement.nextElementSibling;
			let prdList = document.querySelectorAll('.prd_11st>tbody>tr'); 
			let prdList_arr = Array.from(prdList);
			let prdSort = []; 
			...
			let tbodyTag = document.querySelector('.prd_11st>tbody');
