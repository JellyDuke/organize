...
//				mv.setRecount(recount_str);
	...
	public int registReview(Review review, HttpSession session) {
		...
		try {
			insertResult = mvdao.insertReviewInfo(review);
	...
	public ArrayList<HashMap<String, String>> getReviewList(String mvcode) {
		ArrayList<HashMap<String, String>> rvList = mvdao.selectRvList(mvcode);
		return rvList;
	}
}
