...
<html>
    ...
    <body>
        ...
        <div id="contents" style="background-image: url('https://cdn.pixabay.com/photo/2021/07/23/21/26/dots-6488171_640.jpg');">

            <div class="formWrap">
                <form action="${pageContext.request.contextPath}/memLogin" method="post" onsubmit="return loginFormCheck(this)">
                    ...
                    <p class="checkMsg d-none" id="idMsg">아이디를 입력해 주세요!</p>

                    <div class="formInput" id="inputPwDiv">
                        <input type="text" name="loginPw" placeholder="비밀번호">
                    </div>
					<p class="checkMsg d-none" id="pwMsg">비밀번호를 입력해 주세요!</p>
    ...
    <script>
        function loginFormCheck(formObj){
            ...
            let idEl = formObj.loginId; // form >> <input name = 'loginId'>
            let pwEl = formObj.loginPw; // form >> <input name = 'loginPw'>
			let checkForm = true;
