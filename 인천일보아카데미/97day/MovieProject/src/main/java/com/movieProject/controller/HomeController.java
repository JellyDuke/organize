...
public class HomeController {
	...
	public ModelAndView movieList() {
		...
		ModelAndView mav = new ModelAndView();
		ArrayList<Movie> movieList = mvsvc.getMovieList2();
	...
	public ModelAndView reserveMovie() {
		...
		ModelAndView mav = new ModelAndView();
		//영화 목록
		ArrayList<Movie> reserveMovie = mvsvc.getMovieList2();
		mav.addObject("reserveMovie",reserveMovie);
		
		//극장 목록
		ArrayList<Theater> reserveTheater = mvsvc.getReserveTheater();
	...
	public @ResponseBody String getMovieList_json() {
		System.out.println("예매페이지_영화 목록 조회 요청");
		
		ArrayList<Movie> movList = mvsvc.getMovieList2();
