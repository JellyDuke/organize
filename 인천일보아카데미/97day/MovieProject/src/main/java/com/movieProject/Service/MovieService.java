...
//				movGrade = "15";
	...
	public ArrayList<Movie> getMovieList2() {
...
//				movGrade = "15";
	...
	public ArrayList<Theater> getReserveTheater() {
		System.out.println("SERVICE - getReserveTheater");
		
		ArrayList<Theater> reserveTheaterList = mvdao.selectThReserveList();
		return reserveTheaterList;
	}
