...
public interface MemberDao {
	...
	//@Select("SELECT MID, MPW,MNAME, TO_CHAR(MBIRTH, 'YYYY-MM-DD') AS MBIRTH FROM MEMBERS WHERE MID = #{inputId});
	//Member selectMemberInfo(@Param("infoId")String infoId);
	Member selectMemberInfo(@Param("infoId")String infoId);
...
//	int joinInsertInfo(Member mem);
	...
	Member selectMemberLogin(@Param("mid")String mid, @Param("mpw")String mpw);
