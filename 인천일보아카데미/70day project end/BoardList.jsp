            ...
            <div class="formWrap">
				...
				<c:forEach items="${bList }" var="board">
                	<tr style="border: 3px solid black; text-align: center; color: black">
                		<td>${board.bno }</td>
                		<td class="Btitle"><a href="${pageContext.request.contextPath}/boardView?bno=${board.bno }">${board.btitle }
        ...
        <div id="contents" style="background-image: url('https://cdn.pixabay.com/photo/2018/04/06/15/17/pattern-3296033_640.png');">
            ...
            <div class="formWrap">
				...
				<c:forEach items="${bListMap }" var="bomap">
                	<tr style="border: 3px solid black; text-align: center; color: black">
                		<td>${bomap.BNO }</td>
                		<td class="Btitle"><a href="${pageContext.request.contextPath}/boardView?bno=${bomap.BNO }">${bomap.BTITLE }
                		<c:if test="${bomap.BFILENAME !=  null}">
                			<span><i class="fa-regular fa-image"></i></span>
                		</c:if>
                		<c:if test="${bomap.RECOUNT != 0}">
                			<i class="fa-regular fa-comment-dots"></i>
                			<span style ="font-size: 16px;">
                			${bomap.RECOUNT }
                			</span>
